    ...
    <div class="mt-3">
              <?php $draw = rand(1,22);
                if ($draw == 1){
                  ...
                  $result ='16、スターバックスのロゴの人魚は実は神話の怪物!!  美しい歌声で航行中の人を惑わすギリシャ神話に登場する怪物”セイレーン”がモデル';
                } elseif ($draw == 17){
                  ...
                  $result ='21、最高価格で落札されたコーヒー豆(BoP2021 1位 サザコーヒー落札)は1gで約615円 カップ1杯抽出に必要な生豆原価のみで約1万円する';
                }elseif ($draw == 22){
                  $result ='22、スターバックスのロゴのモデル”セイレーン”の歌声が聞こえると助からないことから危険信号を表す”サイレン”の語源になっている';
                }
              ?>
